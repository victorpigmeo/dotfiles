...
(defun scroll-up-right-window ()
  "Scroll up right window"
  (interactive)
  (save-selected-window
    (when-let ((right-window (-first (lambda (w)
                                        (and (window-full-height-p w)
                                             (not (eq w (get-buffer-window))))) (window-list))))
      (select-window right-window)
      (scroll-up-line))))

(defun scroll-down-right-window ()
  "Scroll down right window"
  (interactive)
  (save-selected-window
    (when-let ((right-window (-first (lambda (w)
                                       (and (window-full-height-p w)
...
(map! :nvi
      ...
      :desc "scroll up right/left window"
      "C-M-s-<up>" #'scroll-up-right-window

      :desc "scroll down right/left window"
      "C-M-s-<down>" #'scroll-down-right-window
