...
map("n", "<leader>jd", function()
  require("config.build").refresh_jdtls()
end, { desc = "Refresh jdtls (re-read build config)" })
map("n", "<leader>jD", function()
  require("config.build").refresh_deps()
end, { desc = "Refresh Gradle deps + jdtls" })
map("n", "<leader>jt", function()
  require("config.test").run_nearest()
end, { desc = "Run nearest test" })
map("n", "<leader>jT", function()
  require("config.test").run_nearest(true)
end, { desc = "Run nearest test (--info)" })
